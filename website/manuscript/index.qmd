...
OpenSkiMap provides a resource of `{python} var("openskimap__ski_areas__counts__02_downhill", ",")` downhill ski areas in XX countries and `{python} var("openskimap__runs__counts__03_downhill", ",")` downhill ski runs comprised of XX segments.
