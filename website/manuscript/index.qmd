...
Existing scholarly literature related to downhill skiing is limited and primarily focuses on economics, health impacts, environmental sustainability [@ski-resort-sustainability; @apennines-winter], the threat from climate change [@climate-change-europe; @climate-change-alps; @climate-change-usnf], or ski trail routing algorithms [@skivis; @osm-ski-routing].
