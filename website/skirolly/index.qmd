...
they're essential for navigating the mountain, finding the fastest lift, or planning your next epic run.
@cr-southface

In particular, this map,
beautifully painted by the legendary [James Niehues](https://en.wikipedia.org/wiki/James_Niehues),
is of the [**South Face**]{style="color: #FF8C42;"} of Big Sky, Montana.

But have you ever wondered how common south-facing slopes are?
In other words, do most ski trails in this hemisphere favor [**southern**]{style="color: #FF8C42;"} aspects,
...
Similar to how [wind roses](https://en.wikipedia.org/wiki/Wind_rose) chart wind speed and direction at a location,
...
with its length proportional to the [**total length**]{style="color: #FFC857;"} and [**vertical drop**]{style="color: #36B37E;"} of trail segments in that direction.<br><br>
