...
Our analysis of the orientation of *all* ski areas across the globe revealed a strong [poleward]{style="color: #36B37E;"} and moderate [eastward]{style="color: #FFC857;"} preference.<br><br>
...
::::{.cr-section layout="overlay-center"}
In addition to trail bearings, we have published data on other key metrics of a ski area like [**total vert**]{style="color: #FFC857;"}, [**number of lifts**]{style="color: #36B37E;"}, and [**peak elevation**]{style="color: #FF8C42;"} for ski areas across the world.
<br><br>
