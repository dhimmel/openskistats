...
shows the [**South Face**]{style="color: #FF8C42;"} of Big Sky, Montana, 🇺🇸.
...
In the New Hampshire/Vermont region, ...
@cr-openskimap
...
On powder days,
you can ski from from [**Winslow**]{style="color: #36B37E;"} across the Grafton Turnpike and glide right to the bottom of [**Holt's**]{style="color: #FF8C42;"} Ledge Double.
[@cr-dots-only]
...
with its radius proportional to the [**combined vertical**]{style="color: #36B37E;"} of trail segments in that direction.<br><br>
...
Our analysis of the orientation of *all* ski areas across the globe revealed a clear [poleward]{style="color: #36B37E;"} and slight [eastward]{style="color: #FFC857;"} preference.<br><br>
In other words, the majority of runs in the [northern]{style="color: #36B37E;"} hemisphere are oriented toward the [north]{style="color: #36B37E;"} and [east]{style="color: #FFC857;"},
